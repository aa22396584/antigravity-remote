...
void main() {
  group('CloudRelayClient Tests', () {
    test('callUnary encodes ProxyCommandRequest and decodes base64 payload response', () async {
      final mockHttpClient = MockClient((request) async {
        ...
        expect(reqBody['rpc_path'], '/exa.LanguageServerService/SendUserCascadeMessage');

        // Check base64 input
        final inputBytes = base64Decode(reqBody['payload'] as String);
        expect(utf8.decode(inputBytes), 'Ping Antigravity');

        final respPayload = base64Encode(utf8.encode('Pong from Antigravity'));
