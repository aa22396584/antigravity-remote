...
void main() {
  group('NotificationService Tests', () {
    ...
    test(
      'notifies approval needed and deduplicates repeated step approvals (Issue #33)',
      () async {
        final notifications = <InAppNotification>[];
        final sub = NotificationService.instance.notificationStream.listen(
          notifications.add,
        );
    ...
    test(
      'notifies task completion and failure with event deduplication (Issue #33)',
      () async {
        final notifications = <InAppNotification>[];
        final sub = NotificationService.instance.notificationStream.listen(
          notifications.add,
