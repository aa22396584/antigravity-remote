...
void main() {
  group('Utf8ChunkDecoder Tests', () {
    ...
    test('recovers Chinese characters cut across packets without replacement character', () {
      final decoder = Utf8ChunkDecoder();
      ...
      final chunk2 = fullBytes.sublist(2, 5); // 3rd byte of '測' + first 2 bytes of '試'
      final chunk3 = fullBytes.sublist(5);    // remaining

      final part1 = decoder.decodeChunk(chunk1);
      expect(part1, isEmpty); // Incomplete sequence should not emit or corrupt
